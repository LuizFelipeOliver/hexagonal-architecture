...
class ProductServiceTest {
    ...
    void createProductShouldDelegateToRepositorySave() {
        Product product = new Product(null, "Notebook", new BigDecimal("2500.00"));
    ...
    @Test
    void listProductShouldReturnListOfProducts() {
    ...
    @Test
    void updateProductShouldDelegateToRepositorySave() {
        Product product = new Product(1L, "Notebook Pro", new BigDecimal("3000.00"));
